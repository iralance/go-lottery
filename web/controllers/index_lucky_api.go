...
import (
	...
	utils "github.com/iralance/go-lottery/uitls"
	"log"
)
...
func (api *LuckyApi) luckDo(uid int, username, ip string) (int, string, *models.ObjGiftPrize) {
	...
	_, err := services.NewResultService().Create(&result)
	if err != nil {
